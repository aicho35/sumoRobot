...
// Sound Effects
ZumoBuzzer buzzer;
const char sound_effect[] PROGMEM = "O4"; // "charge" melody
...
void loop()
{
  ...
  if (sensor_values[0] < QTR_THRESHOLD) // || sensor_values[1] < QTR_THRESHOLD || sensor_values[2] < QTR_THRESHOLD)
  {
    // if leftmost sensor detects line, reverse and turn to the right
    turn(RIGHT, true);
  }
  else if (sensor_values[5] < QTR_THRESHOLD)// || sensor_values[4] < QTR_THRESHOLD || sensor_values[5] < QTR_THRESHOLD)
  {
